...
public class QuestionaryCompareUtil {
    ...
    public static void contractorCompare(com.rbkmoney.questionary.Contractor thriftContractor,
                                         Contractor swagContractor) {
        if (swagContractor instanceof IndividualEntityContractor) {
            com.rbkmoney.questionary.RussianIndividualEntity thriftRussianIndividualEntity =
            ...
            for (int i = 0; i < thriftLegalEntity.getRussianLegalEntity().getBeneficialOwners().size(); i++) {
                com.rbkmoney.questionary.BeneficialOwner beneficialOwner =
    ...
    private static void comparePropertyInfoDocType(
            com.rbkmoney.questionary.PropertyInfoDocumentType thriftPropertyInfoDocumentType,
    ...
    private static void additionalInfoCompare(com.rbkmoney.questionary.AdditionalInfo thriftAdditionalInfo,
        ...
        for (int i = 0; i < thriftAdditionalInfo.getFinancialPosition().size(); i++) {
            com.rbkmoney.questionary.FinancialPosition thriftFinancialPosition =
    ...
    private static void compareBusinessInfo(com.rbkmoney.questionary.BusinessInfo thriftBusinessInfo,
    ...
    private static void compareFinancialPosition(com.rbkmoney.questionary.FinancialPosition thriftFinancialPosition,
    ...
    private static void compareMonthOperationSum(com.rbkmoney.questionary.MonthOperationSum thriftMonthOperationSum,
                                                 MonthOperationSum swagMonthOperationSum) {
        if (swagMonthOperationSum == MonthOperationSum.BTWFIVEHUNDREDTHOUSANDTOONEMILLION) {
            Assert.assertSame(com.rbkmoney.questionary.MonthOperationSum.btw_five_hundred_thousand_to_one_million,
            ...
            Assert.assertSame(com.rbkmoney.questionary.MonthOperationSum.lt_five_hundred_thousand,
                    thriftMonthOperationSum);
        }
    }

    private static void compareAccountantInfo(com.rbkmoney.questionary.AccountantInfo thriftAccountantInfo,
    ...
    public static void contactInfoCompare(com.rbkmoney.questionary.ContactInfo thriftContactInfo,
    ...
    private static void founderInfoCompare(com.rbkmoney.questionary.FoundersInfo thriftFoundersInfo,
    ...
    private static void individualPersonCompare(com.rbkmoney.questionary.IndividualPerson thriftIndividualPerson,
    ...
    private static void beneficialOwnerCompare(com.rbkmoney.questionary.BeneficialOwner thriftBeneficialOwner,
                                               BeneficialOwner swagBeneficialOwner) {
    ...
    private static void russianPrivateEntityCompare(
            com.rbkmoney.questionary.RussianPrivateEntity thriftRussianPrivateEntity,
    ...
    private static void residencyApproveCompare(com.rbkmoney.questionary.ResidenceApprove thriftResidenceApprove,
    ...
    private static void residencyInfoCompare(com.rbkmoney.questionary.ResidencyInfo thriftResidencyInfo,
    ...
    private static void registrationInfoCompare(com.rbkmoney.questionary.RegistrationInfo thriftRegistrationInfo,
    ...
    private static void principalActivityCompare(com.rbkmoney.questionary.Activity thriftPrincipalActivity,
    ...
    private static void migrationCardInfoCompare(com.rbkmoney.questionary.MigrationCardInfo thriftMigrationCardInfo,
    ...
    private static void licenseInfoCompare(com.rbkmoney.questionary.LicenseInfo thriftLicenseInfo,
    ...
    private static void individualPersonCategoriesCompare(
            com.rbkmoney.questionary.IndividualPersonCategories thriftIndividualPersonCategories,
    ...
    private static void identityDocumentCompare(com.rbkmoney.questionary.IdentityDocument thriftIdentityDocument,
