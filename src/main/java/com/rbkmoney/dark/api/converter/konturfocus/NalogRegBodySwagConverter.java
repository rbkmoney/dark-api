...
public class NalogRegBodySwagConverter
        implements SwagConverter<NalogRegBody, com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.NalogRegBody> {

    @Override
    public NalogRegBody toSwag(com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.NalogRegBody value,
