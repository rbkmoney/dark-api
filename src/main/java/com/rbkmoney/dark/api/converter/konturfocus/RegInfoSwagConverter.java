...
public class RegInfoSwagConverter
        implements SwagConverter<RegInfo, com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.RegInfo> {

    @Override
    public RegInfo toSwag(com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.RegInfo value,
