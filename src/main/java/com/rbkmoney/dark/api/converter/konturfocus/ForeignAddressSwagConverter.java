...
public class ForeignAddressSwagConverter
        implements SwagConverter<ForeignAddress, com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.ForeignAddress> {

    @Override
    public ForeignAddress toSwag(com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.ForeignAddress value,
