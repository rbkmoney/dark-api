...
public class LegalAddressConverter
        implements SwagConverter<LegalAddress, com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.LegalAddress> {
    @Override
    public LegalAddress toSwag(com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.LegalAddress value,
