...
@Component
public class BeneficialOwnerOtherSwagConverter
        implements SwagConverter<BeneficialOwnerOther, com.rbkmoney.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerOther> {

    @Override
    public BeneficialOwnerOther toSwag(com.rbkmoney.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerOther value, SwagConverterContext ctx) {
