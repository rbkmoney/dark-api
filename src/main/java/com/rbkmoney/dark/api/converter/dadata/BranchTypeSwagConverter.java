...
public class BranchTypeSwagConverter
        implements SwagConverter<BranchType, com.rbkmoney.questionary_proxy_aggr.base_dadata.BranchType> {

    @Override
    public BranchType toSwag(com.rbkmoney.questionary_proxy_aggr.base_dadata.BranchType value,
