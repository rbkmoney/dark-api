...
public class BeneficialOwnerResponseSwagConverter
        implements SwagConverter<BeneficialOwnerResponse, com.rbkmoney.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerResponse> {

    @Override
    public BeneficialOwnerResponse toSwag(com.rbkmoney.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerResponse value, SwagConverterContext ctx) {
        ...
        if (value.isSetBeneficialOwners()) {
            ...
            if (value.getBeneficialOwners().isSetBeneficialOwnersFl()) {
                List<BeneficialOwnerFl> beneficialOwnerFlList = value.getBeneficialOwners().getBeneficialOwnersFl().stream()
            ...
            if (value.getBeneficialOwners().isSetBeneficialOwnersUl()) {
                List<BeneficialOwnerUl> beneficialOwnerUlList = value.getBeneficialOwners().getBeneficialOwnersUl().stream()
            ...
            if (value.getBeneficialOwners().isSetBeneficialOwnersForeign()) {
                List<BeneficialOwnerForeign> beneficialOwnerForeignList = value.getBeneficialOwners().getBeneficialOwnersForeign().stream()
                        .map(beneficialOwnerForeign -> ctx.convert(beneficialOwnerForeign, BeneficialOwnerForeign.class))
                        .collect(Collectors.toList());
            ...
            if (value.getBeneficialOwners().isSetBeneficialOwnersOther()) {
                List<BeneficialOwnerOther> beneficialOwnerOtherList = value.getBeneficialOwners().getBeneficialOwnersOther().stream()
                        .map(beneficialOwnerOther -> ctx.convert(beneficialOwnerOther, BeneficialOwnerOther.class))
                        .collect(Collectors.toList());
        ...
        if (value.isSetHistoricalBeneficialOwners()) {
            ...
            if (value.getHistoricalBeneficialOwners().isSetBeneficialOwnersFl()) {
                List<BeneficialOwnerFl> beneficialOwnerFlList = value.getHistoricalBeneficialOwners().getBeneficialOwnersFl().stream()
                        .map(beneficialOwnerFl -> ctx.convert(beneficialOwnerFl, BeneficialOwnerFl.class))
                        .collect(Collectors.toList());
                beneficialOwners.setBeneficialOwnerFl(beneficialOwnerFlList);
            }
            ...
            if (value.getHistoricalBeneficialOwners().isSetBeneficialOwnersUl()) {
                List<BeneficialOwnerUl> beneficialOwnerUlList = value.getHistoricalBeneficialOwners().getBeneficialOwnersUl().stream()
                        .map(beneficialOwnerUl -> ctx.convert(beneficialOwnerUl, BeneficialOwnerUl.class))
                        .collect(Collectors.toList());
                beneficialOwners.setBeneficialOwnersUl(beneficialOwnerUlList);
            }
            ...
            if (value.getHistoricalBeneficialOwners().isSetBeneficialOwnersForeign()) {
                List<BeneficialOwnerForeign> beneficialOwnerForeignList = value.getHistoricalBeneficialOwners().getBeneficialOwnersForeign().stream()
                        .map(beneficialOwnerForeign -> ctx.convert(beneficialOwnerForeign, BeneficialOwnerForeign.class))
                        .collect(Collectors.toList());
                beneficialOwners.setBeneficialOwnersForeign(beneficialOwnerForeignList);
            }
            ...
            if (value.getHistoricalBeneficialOwners().isSetBeneficialOwnersOther()) {
                List<BeneficialOwnerOther> beneficialOwnerOtherList = value.getHistoricalBeneficialOwners().getBeneficialOwnersOther().stream()
                        .map(beneficialOwnerOther -> ctx.convert(beneficialOwnerOther, BeneficialOwnerOther.class))
                        .collect(Collectors.toList());
                beneficialOwners.setBeneficialOwnersOther(beneficialOwnerOtherList);
            }
