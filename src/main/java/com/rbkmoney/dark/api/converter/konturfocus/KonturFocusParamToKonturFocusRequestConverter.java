    ...
    public KonturFocusRequestHolder toThrift(KonturFocusParams konturFocusParams, ThriftConverterContext ctx) {
        ...
        switch (konturFocusParams.getRequest().getKonturFocusRequestType()) {
            case REQQUERY:
                ...
                var swagReqQuery =
                        (com.rbkmoney.swag.questionary_aggr_proxy.model.ReqQuery) konturFocusParams.getRequest();
            ...
            case EGRDETAILSQUERY:
                ...
                var swagEgrDetails =
                        (com.rbkmoney.swag.questionary_aggr_proxy.model.EgrDetailsQuery) konturFocusParams.getRequest();
            ...
            case LICENCESQUERY:
                ...
                var swagLicenseQuery =
                        ((com.rbkmoney.swag.questionary_aggr_proxy.model.LicencesQuery) konturFocusParams.getRequest());
            ...
            case BENEFICIALOWNERQUERY:
                ...
                var swagBeneficialOwnerQuery =
                        (com.rbkmoney.swag.questionary_aggr_proxy.model.BeneficialOwnerQuery) konturFocusParams
                                .getRequest();
