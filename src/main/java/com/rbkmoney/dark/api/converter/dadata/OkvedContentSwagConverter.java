...
public class OkvedContentSwagConverter
        implements SwagConverter<OkvedContent, com.rbkmoney.questionary_proxy_aggr.dadata_okved2.OkvedContent> {

    @Override
    public OkvedContent toSwag(com.rbkmoney.questionary_proxy_aggr.dadata_okved2.OkvedContent value,
