...
public class LegalNameSwagConverter
        implements SwagConverter<LegalName, com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.LegalName> {

    @Override
    public LegalName toSwag(com.rbkmoney.questionary_proxy_aggr.base_kontur_focus.LegalName value,
